...
begin
  for i in 0..jsonb_array_length(specs)-1 loop
    ...
    values (v_slug, v_title, v_topic,
      'https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=' ||
        public.urlencode('premium editorial healthcare illustration, soft pastel nutrition education, ' || v_title || ', glassmorphism card art, elegant minimal website visual') ||
